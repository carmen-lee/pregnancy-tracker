        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block">
              <h5 style = "background-color:white; color: green;">You are not pregnant!</h5>
            </div>';
            } else if ($weeks > 26) {
              echo '<img src="../../imgs/third-trimester.jpeg" class="d-block mh-50" alt="3rd trimester">
            <div class="carousel-caption d-none d-md-block">
              <h5 style = "background-color:white; color: green">You are ', $weeks, ' weeks into pregnancy (3rd Trimester)!</h5>
              <p style = "background-color:white; color: green">Baby is almost here!</p>
              <div class="progress">
            ...
            <div class="carousel-caption d-none d-md-block">
              <h5 style = "background-color:white; color: green">You are ', $weeks, ' weeks into pregnancy (2nd Trimester)!</h5>
              <p style = "background-color:white; color: green">Almost there!</p>
              <div class="progress">
              <div class="progress-bar bg-success progress-bar-striped progress-bar-animated" role="progressbar" style="width: ', $mPercent, '%;">
              Time till estimated birth: ', $months, ' months ', $days, ' days 
              </div>
              ...
              <div class="carousel-caption d-none d-md-block">
                <h5 style = "background-color:white; color: green;">You are ', $weeks, ' weeks into pregnancy (1st Trimester)!</h5>
                <p style = "background-color:white; color: green;">Congrats!</p>
                <div class="progress">
                <div class="progress-bar bg-success progress-bar-striped progress-bar-animated" role="progressbar" style="width: ', $mPercent, '%;">
                Time till estimated birth: ', $months, ' months ', $days, ' days 
                </div>
